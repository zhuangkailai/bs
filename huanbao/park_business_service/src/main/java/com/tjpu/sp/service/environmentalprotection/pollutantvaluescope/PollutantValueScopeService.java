package com.tjpu.sp.service.environmentalprotection.pollutantvaluescope;
...
public interface PollutantValueScopeService {
     ...
     * @throws:
     */
    Map<String,Object> getPollutantValueScopeDetailByID(String pkid);
}
