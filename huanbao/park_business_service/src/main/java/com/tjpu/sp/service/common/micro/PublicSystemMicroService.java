...
import com.tjpu.sp.service.impl.common.FeignFallback.PublicSystemMicroServiceImpl;
 ...
 */
@Service
@FeignClient(value = "publicSystem", path = "/publicSystem", fallback = PublicSystemMicroServiceImpl.class)

public interface PublicSystemMicroService {
    ...
    */
    ...
    @RequestMapping(value = "generalMethod/exportExcel", method = RequestMethod.POST)
    ResponseEntity<byte[]> exportExcel(@RequestParam("microparam") String microParam);
}
