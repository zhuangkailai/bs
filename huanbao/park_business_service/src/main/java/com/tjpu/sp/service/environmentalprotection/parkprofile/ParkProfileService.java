package com.tjpu.sp.service.environmentalprotection.parkprofile;
...
public interface ParkProfileService {
     ...
     * @throws:
     */
    Map<String,Object> getParkProfileDetailByID(String pkid);
}
