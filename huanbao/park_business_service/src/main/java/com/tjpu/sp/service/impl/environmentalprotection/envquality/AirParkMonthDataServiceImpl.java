...
@Service
@Transactional
public class AirParkMonthDataServiceImpl implements AirParkMonthDataService {
    @Autowired
    @Qualifier("primaryMongoTemplate")
    private MongoTemplate mongoTemplate;

    private final String hourCollection = "ParkHourAQIData";
    private final String dayCollection = "ParkDayAQIData";
    ...
    public Map<String, Map<String, Object>> getAirCityMonthCompositeIndexByMonitorTimes(String starttime, String endtime) throws Exception {
        ...
        AggregationResults<Document> cityHourAQIData = mongoTemplate.aggregate(aggregation, hourCollection, Document.class);
        ...
        if (effectiveHourList != null) {
            ...
            for (String monthKey : monthAndStrength.keySet()) {
                ...
                if (strengths.size() > 1) {
                    ...
                    monthAndValue.put(monthKey, strengths.get(0));
                }
            }
        }
     ...
     */
    @Override
    public Map<String, Double> getAirCityConcentrationByMonitorTimes(String monitortime) {
