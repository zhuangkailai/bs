...
public class GasOutPutPollutantSetVO {
    private String pkDataid;

    private String fkPollutionid;

    private String fkGasoutputid;
    ...
    private Integer ishasconvertdata;
    ...
    public Integer getIshasconvertdata() {
        return ishasconvertdata;
    }

    public void setIshasconvertdata(Integer ishasconvertdata) {
        this.ishasconvertdata = ishasconvertdata;
    }
    ...
    public String getFkGasoutputid() {
        return fkGasoutputid;
    }

    public void setFkGasoutputid(String fkGasoutputid) {
        this.fkGasoutputid = fkGasoutputid == null ? null : fkGasoutputid.trim();
    }
