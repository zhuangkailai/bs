...
public class AirStationPollutantSetVO {
    private String pkDataid;

    private String fkAirmonintpointid;
    ...
    public String getFkAirmonintpointid() {
        return fkAirmonintpointid;
    }

    public void setFkAirmonintpointid(String fkAirmonintpointid) {
        this.fkAirmonintpointid = fkAirmonintpointid;
    }
