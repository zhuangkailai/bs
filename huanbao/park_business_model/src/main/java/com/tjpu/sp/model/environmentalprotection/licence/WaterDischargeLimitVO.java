...
public class WaterDischargeLimitVO {
    private String pkId;
    ...
    private Double permitupperconcentration;

    private Double permitlowerconcentration;
    ...
    public Double getPermitupperconcentration() {
        return permitupperconcentration;
    }

    public void setPermitupperconcentration(Double permitupperconcentration) {
        this.permitupperconcentration = permitupperconcentration;
    }

    public Double getPermitlowerconcentration() {
        return permitlowerconcentration;
    }

    public void setPermitlowerconcentration(Double permitlowerconcentration) {
        this.permitlowerconcentration = permitlowerconcentration;
    }
