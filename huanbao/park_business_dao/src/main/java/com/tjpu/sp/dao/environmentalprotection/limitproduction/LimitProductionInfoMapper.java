...
public interface LimitProductionInfoMapper {
    int deleteByPrimaryKey(String pkId);

    int insert(LimitProductionInfoVO record);

    int insertSelective(LimitProductionInfoVO record);

    LimitProductionInfoVO selectByPrimaryKey(String pkId);

    int updateByPrimaryKeySelective(LimitProductionInfoVO record);

    int updateByPrimaryKey(LimitProductionInfoVO record);
