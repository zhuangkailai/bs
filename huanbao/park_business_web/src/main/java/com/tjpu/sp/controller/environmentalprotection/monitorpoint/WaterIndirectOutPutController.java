 ...
 * @Description: 废水间接排口控制类
 * @updateUser:
 * @updateDate:
 * @updateDescription:
 */
@RestController
@RequestMapping("waterIndirect")
public class WaterIndirectOutPutController {
    ...
    private String sysmodel = "waterIndirectOutlet";
    private String pk_id = "pk_id";
    private String listfieldtype = "list-indirectwater";
    /**
     * 数据源
     */
     ...
     * @throws:
     */
    @RequestMapping(value = "/getWaterIndirectOutPutListPage", method = RequestMethod.POST)
    public Object getWaterIndirectOutPutListPage(HttpServletRequest request ) {
        try {
            //获取userid
     ...
     * @throws:
     */
    @RequestMapping(value = "/getWaterIndirectOutPutByParamMap", method = RequestMethod.POST)
    public Object getWaterIndirectOutPutByParamMap(@RequestJson(value = "paramsjson", required = false) Object map) {
        try {
     ...
     * @throws:
     */
    @RequestMapping(value = "getWaterIndirectOutPutAddPage", method = RequestMethod.POST)
    public Object getWaterIndirectOutPutAddPage() {
        try {
            //设置参数
            ...
            paramMap.put("addfieldtype", "add-waterindirect");
                ...
                if (jsonObject.get("data")!=null){
                    ...
                    if (data.get("addcontroldata")!=null) {
                        ...
                        for (Map<String,Object> map: addcontroldata){
                            if (map.get("name")!=null&&"fk_sewageplant".equals(map.get("name").toString())){
     ...
     * @throws:
     */
    @RequestMapping(value = "addWaterIndirectOutPut", method = RequestMethod.POST)
    public Object addWaterIndirectOutPut(HttpServletRequest request ) throws Exception {
        try {
            Map<String, Object> paramMap = RequestUtil.parseRequest(request);
            //设置参数
            paramMap.put("sysmodel", sysmodel);
     ...
     * @throws:
     */
    @RequestMapping(value = "getWaterIndirectOutPutUpdatePageByID", method = RequestMethod.POST)
    public Object getWaterIndirectOutPutUpdatePageByID(@RequestJson(value = "id", required = true) String id) throws Exception {
        try {
            Map<String, Object> paramMap = new HashMap<String, Object>();
            //设置参数
            paramMap.put("sysmodel", sysmodel);
            ...
            paramMap.put("datasource", datasource);
            paramMap.put("editfieldtype", "edit-waterindirect");
     ...
     * @throws:
     */
    @RequestMapping(value = "updateWaterIndirectOutPut", method = RequestMethod.POST)
    public Object updateWaterIndirectOutPut(HttpServletRequest request ) throws Exception {
        try {
            Map<String, Object> paramMap = RequestUtil.parseRequest(request);
            //设置参数
            paramMap.put("sysmodel", sysmodel);
     ...
     * @throws:
     */
    @RequestMapping(value = "deleteWaterIndirectOutPutByID", method = RequestMethod.POST)
    public Object deleteWaterIndirectOutPutByID(@RequestJson(value = "id", required = true) String id) throws Exception {
        try {
            Map<String, Object> paramMap = new HashMap<String, Object>();
            //设置参数
            paramMap.put("sysmodel", sysmodel);
     ...
     * @throws:
     */
    @RequestMapping(value = "getWaterIndirectOutPutDetailByID", method = RequestMethod.POST)
    public Object getWaterIndirectOutPutDetailByID(@RequestJson(value = "id", required = true) String id) throws Exception {
        try {
            Map<String, Object> paramMap = new HashMap<String, Object>();
            //设置参数
            paramMap.put("sysmodel", sysmodel);
            paramMap.put(pk_id, id);
            paramMap.put("datasource", datasource);
            paramMap.put("detailfieldtype", "detail-indirectwater");
     ...
     * @Description: 通过id查询废水间接排口信息和污染物信息详情
     * @updateUser:
     * @updateDate:
     * @updateDescription:
     * @param:
     * @return:
     */
    @RequestMapping(value = "getWaterIndirectOutPutAndPollutantDetailByID", method = RequestMethod.POST)
    public Object getWaterIndirectOutPutAndPollutantDetailByID(@RequestJson(value = "id", required = true) String id) throws Exception {
        try {
