...
public class SecondMongoConfigure implements EnvironmentAware {
    ...
    public MongoTemplate mongoDbFactory(Environment environment) {
        ...
        String host = environment.getProperty("mongodb.second.host");
        String port = environment.getProperty("mongodb.second.port");
        ...
        String dataBase = environment.getProperty("mongodb.second.database");
        String dbUser = environment.getProperty("mongodb.second.username");
        String dbPwd = environment.getProperty("mongodb.second.password");
