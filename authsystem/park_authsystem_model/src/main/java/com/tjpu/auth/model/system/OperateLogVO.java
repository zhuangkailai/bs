...
public class OperateLogVO {
    ...
    private String baseOperateIp;

    public String getBaseOperateIp() {
        return baseOperateIp;
    }

    public void setBaseOperateIp(String baseOperateIp) {
        this.baseOperateIp = baseOperateIp;
    }
